...
#. "$SCRIPT_DIR/../../lilak.sh"
source /Users/jungwoo/Research/lilak/lilak.sh

#RUN=111 MAPPING=mapping_QB_DepV_Measure lilak run auto_reco.mac # QQQ5 112
#RUN=112 MAPPING=mapping_QB_DepV_Measure lilak run auto_reco.mac # QQQ5 50
#RUN=113 MAPPING=mapping_QB_DepV_Measure lilak run auto_reco.mac # QQQ5 90
#RUN=114 MAPPING=mapping_QB_DepV_Measure lilak run auto_reco.mac # QQQ5 70
#RUN=115 MAPPING=mapping_QB_DepV_Measure lilak run auto_reco.mac # QQQ5 60
#RUN=116 MAPPING=mapping_QB_DepV_Measure lilak run auto_reco.mac # QQQ5 100
#RUN=117 MAPPING=mapping_QB_DepV_Measure lilak run auto_reco.mac # QQQ5 120
#RUN=118 MAPPING=mapping_QB_DepV_Measure lilak run auto_reco.mac # QQQ5 130
#RUN=119 MAPPING=mapping_QB_DepV_Measure lilak run auto_reco.mac # QQQ5 140
#RUN=120 MAPPING=mapping_QB_DepV_Measure lilak run auto_reco.mac # QQQ5 150
#RUN=121 MAPPING=mapping_QB_DepV_Measure lilak run auto_reco.mac # QQQ5 160
#RUN=122 MAPPING=mapping_QB_DepV_Measure lilak run auto_reco.mac # QQQ5 170
#RUN=123 MAPPING=mapping_QB_DepV_Measure lilak run auto_reco.mac # QQQ5 180
